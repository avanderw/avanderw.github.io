...
| Performance Level | Definition | 2025 Status |
| :---- | :---- | :---- |
| **Level 1: Emerging** | Outperforms unskilled humans (e.g., ChatGPT, LLaMA 2). | Current baseline for all major models. |
| **Level 2: Competent** | Outperforms 50% of skilled adults in non-physical tasks. | Achieved by frontier models in coding and legal tasks. |
| **Level 3: Expert** | Outperforms 90% of skilled adults. | Target for 2025–2026 model releases. |
| **Level 4: Virtuoso** | Outperforms 99% of skilled adults. | Projected for late 2020s. |
| **Level 5: Superhuman** | Outperforms 100% of humans (Artificial Superintelligence). | The ultimate "finish line" of the race. |
...
The fundamental tragedy of the Prisoner’s Dilemma in this context is that although mutual cooperation would benefit everyone by reducing existential risk and ensuring safe alignment, the "rational" choice for each individual actor is to defect. Because reaching AGI is viewed as a "one-time threshold" that grants the winner a definitive advantage, there is no "iterated" game to enforce cooperation through future punishment.

|  | Actor B: Cooperates (Safety) | Actor B: Defects (Race) |
| :---- | :---- | :---- |
| **Actor A: Cooperates (Safety)** | (3, 3\) Moderate, safe growth for both. | (0, 5\) Actor A is left behind; Actor B wins big. |
| **Actor A: Defects (Race)** | (5, 0\) Actor A wins big; Actor B is left behind. | (1, 1\) High risk of catastrophe; winner uncertain. |
...
| Categorical Shift | Abandoned (2023–2024) | Prioritized (2025–2026) |
| :---- | :---- | :---- |
| **Architecture** | "Bolt-on" AI features. | AI-native from the ground up. |
| **Pricing** | Rigid per-seat subscription. | Usage-based / Consumption-based. |
| **Value Prop** | Human coordination/workflow. | Autonomous agent execution. |
...
Salesforce has been the most active strategic buyer in 2025, completing 10 acquisitions—including the $8 billion cash offer for Informatica—to accelerate its "Agentforce" strategy. This strategy focuses on building autonomous digital workers that can manage entire customer service and sales workflows without human oversight. Similarly, ServiceNow has acquired niche technologies like Cuein and Data.World to enhance its AI-driven workflow automation platforms.

Other notable 2025 divestments and acquisitions include:

* **Valsoft:** Acquired Quorum Information Technologies and KidKare to expand its portfolio of "mission-critical" vertical SaaS.  
...
Strategic developments in this theater include:

* **Autonomous Swarms:** The transition from tele-operated drones to autonomous swarms that can coordinate attacks without a direct human link.  
...
| Impact Vector | Mechanism | Strategic Consequence |
| :---- | :---- | :---- |
| **Helium Supply** | Middle East is a primary source. | Bottleneck in semiconductor fabrication cooling. |
| **Energy Prices** | Volatility in Strait of Hormuz. | Spiking data center operating costs ($/TWh). |
| **Physical Infrastructure** | Drone strikes on data centers. | Delays in regional AI hub expansions (e.g., Amazon, Nvidia). |
| **Sovereign Cloud** | National security imperatives. | Acceleration of locally-owned, redundant infrastructure. |
...
Key metrics of the 2025 compute war:

* **Training Scaling:** Compute requirements for frontier models have doubled every six months since 2015\.  
...
| Energy Metric (2030 Projections) | United States | China |
| :---- | :---- | :---- |
| **Data Center Electricity Demand** | 426 TWh (9% of total demand) | 277 TWh |
| **Clean Energy Leadership** | Emerging (Investment in Small Modular Reactors) | Global Leader (Solar, Wind, Batteries) |
| **Grid Constraints** | High (Regulatory hurdles for new projects) | Low (State-led infrastructure build) |
| **Strategic Advantage** | Access to most efficient GPUs. | Access to massive, cheap energy. |
...
Current proposed verification mechanisms include:

* **Hardware Verification:** Installing "narrow-purpose verification hardware" inside data centers to monitor compute usage.  
* **Mutually Verified Data Centers:** Creating international compute hubs that run "privacy-preserving computations" to allow for oversight without revealing proprietary model weights.  
* **Technical Standards:** Building agreement on "red lines" and digital watermarks for deepfakes.
...
* **For Regulators:** Shift from abstract "ethics" to "verifiable safety standards". Support the development of hardware-level verification and "red lines" for high-risk domains like biosecurity and nuclear command and control.
...
3. Deep Dive: Export Controls and the AI Race | Contrary Research, accessed on March 11, 2026, [https://research.contrary.com/report/export-controls-and-the-ai-race](https://research.contrary.com/report/export-controls-and-the-ai-race)  
4. AI Safety is Dead: Game Theory Explains Why \- Lazy Programmer, accessed on March 11, 2026, [https://lazyprogrammer.me/ai-safety-is-dead-game-theory-explains-why/](https://lazyprogrammer.me/ai-safety-is-dead-game-theory-explains-why/)  
5. The Artificial General Intelligence Race and International ... \- RAND, accessed on March 11, 2026, [https://www.rand.org/content/dam/rand/pubs/perspectives/PEA4100/PEA4155-1/RAND\_PEA4155-1.pdf](https://www.rand.org/content/dam/rand/pubs/perspectives/PEA4100/PEA4155-1/RAND_PEA4155-1.pdf)  
6. Artificial general intelligence \- Wikipedia, accessed on March 11, 2026, [https://en.wikipedia.org/wiki/Artificial\_general\_intelligence](https://en.wikipedia.org/wiki/Artificial_general_intelligence)  
7. How will the United States and China power the AI race? \- Brookings Institution, accessed on March 11, 2026, [https://www.brookings.edu/articles/how-will-the-united-states-and-china-power-the-ai-race/](https://www.brookings.edu/articles/how-will-the-united-states-and-china-power-the-ai-race/)  
8. Beyond the Space Race: Collaboration and Competition in the Future of AI Governance, accessed on March 11, 2026, [https://www.stimson.org/2025/collaboration-and-competition-future-of-ai-governance/](https://www.stimson.org/2025/collaboration-and-competition-future-of-ai-governance/)  
9. Game theory \- Wikipedia, accessed on March 11, 2026, [https://en.wikipedia.org/wiki/Game\_theory](https://en.wikipedia.org/wiki/Game_theory)  
10. The Stag Hunt (Game Theory) \- iMotions, accessed on March 11, 2026, [https://imotions.com/blog/learning/research-fundamentals/the-stag-hunt-game-theory/](https://imotions.com/blog/learning/research-fundamentals/the-stag-hunt-game-theory/)  
11. CS 440/ECE448 Lecture 10: Game Theory, accessed on March 11, 2026, [https://courses.grainger.illinois.edu/ece448/sp2018/ece448sp2018lecture10.pdf](https://courses.grainger.illinois.edu/ece448/sp2018/ece448sp2018lecture10.pdf)  
12. Algorithmic Game Theory \- FI MUNI, accessed on March 11, 2026, [https://www.fi.muni.cz/\~xbrazdil/AGT\_2024\_2.pdf](https://www.fi.muni.cz/~xbrazdil/AGT_2024_2.pdf)  
13. GT-HarmBench: Benchmarking AI Safety Risks Through the Lens of Game Theory \- arXiv, accessed on March 11, 2026, [https://arxiv.org/html/2602.12316v1](https://arxiv.org/html/2602.12316v1)  
14. IDC Point of View: First Look at the War in the Middle East and Its Impact on IT Spending in the Region and Globally, accessed on March 11, 2026, [https://www.idc.com/resource-center/blog/idc-point-of-view-first-look-at-the-war-in-the-middle-east-and-its-impact-on-it-spending-in-the-region-and-globally/](https://www.idc.com/resource-center/blog/idc-point-of-view-first-look-at-the-war-in-the-middle-east-and-its-impact-on-it-spending-in-the-region-and-globally/)  
15. Do AI summits work? | Chatham House – International Affairs Think ..., accessed on March 11, 2026, [https://www.chathamhouse.org/2026/02/do-ai-summits-work](https://www.chathamhouse.org/2026/02/do-ai-summits-work)  
16. From safety to impact: what India's AI summit signals about global governance, accessed on March 11, 2026, [https://www.iiss.org/online-analysis/online-analysis/2026/02/from-safety-to-impact-what-indias-ai-summit-signals-about-global-governance/](https://www.iiss.org/online-analysis/online-analysis/2026/02/from-safety-to-impact-what-indias-ai-summit-signals-about-global-governance/)  
17. AI Risks that Could Lead to Catastrophe \- Center for AI Safety (CAIS), accessed on March 11, 2026, [https://safe.ai/ai-risk](https://safe.ai/ai-risk)  
18. GT-HarmBench: Benchmarking AI Safety Risks Through the Lens of Game Theory, accessed on March 11, 2026, [https://www.researchgate.net/publication/400811825\_GT-HarmBench\_Benchmarking\_AI\_Safety\_Risks\_Through\_the\_Lens\_of\_Game\_Theory](https://www.researchgate.net/publication/400811825_GT-HarmBench_Benchmarking_AI_Safety_Risks_Through_the_Lens_of_Game_Theory)  
19. The Paris Summit: Au Revoir, global AI Safety? \- European Policy Centre, accessed on March 11, 2026, [https://www.epc.eu/publication/The-Paris-Summit-Au-Revoir-global-AI-Safety-61ea68/](https://www.epc.eu/publication/The-Paris-Summit-Au-Revoir-global-AI-Safety-61ea68/)  
20. The AI Funding Apocalypse: Why Traditional SaaS Companies Are Being Shut Out of Venture Capital in 2025 \- Development Corporate, accessed on March 11, 2026, [https://developmentcorporate.com/startups/the-ai-funding-apocalypse-why-traditional-saas-companies-are-being-shut-out-of-venture-capital-in-2025/](https://developmentcorporate.com/startups/the-ai-funding-apocalypse-why-traditional-saas-companies-are-being-shut-out-of-venture-capital-in-2025/)  
21. What happened in Q2 2025? A recap of SaaS and AI funding news \- SaaStock, accessed on March 11, 2026, [https://www.saastock.com/blog/saas-and-ai-funding-news-q2-2025/](https://www.saastock.com/blog/saas-and-ai-funding-news-q2-2025/)  
22. Artificial Intelligence (AI) Megadeals Fuel Venture Capital Rebound, but Hide Deepening Geographic and Sectoral Divides \- WIPO, accessed on March 11, 2026, [https://www.wipo.int/en/web/global-innovation-index/w/blogs/2025/ai-venture-capital](https://www.wipo.int/en/web/global-innovation-index/w/blogs/2025/ai-venture-capital)  
23. AI SaaS Investors Reveal Shocking Shift: What They're Abandoning ..., accessed on March 11, 2026, [https://www.mexc.com/news/837102](https://www.mexc.com/news/837102)  
24. Artificial Intelligence Global Report H1 2025 | AI Investment & Deal Trends | Insights, accessed on March 11, 2026, [https://www.ropesgray.com/en/insights/alerts/2025/08/artificial-intelligence-h1-2025-global-report](https://www.ropesgray.com/en/insights/alerts/2025/08/artificial-intelligence-h1-2025-global-report)  
25. Meet the Top Strategic Buyers Acquiring Software Companies ..., accessed on March 11, 2026, [https://softwareequity.com/blog/top-strategic-buyers](https://softwareequity.com/blog/top-strategic-buyers)  
26. The Future of SaaS Investing: 2025 Market Trends, AI, and Founder-Friendly Capital, accessed on March 11, 2026, [https://revtekcapital.com/the-future-of-saas-investing](https://revtekcapital.com/the-future-of-saas-investing)  
27. Code, Command, and Conflict: Charting the Future of Military AI \- Belfer Center, accessed on March 11, 2026, [https://www.belfercenter.org/research-analysis/code-command-and-conflict-charting-future-military-ai](https://www.belfercenter.org/research-analysis/code-command-and-conflict-charting-future-military-ai)  
28. Chasing True AI Autonomy: From Legacy Mindsets to Battlefield Dominance, accessed on March 11, 2026, [https://warontherocks.com/2025/12/chasing-true-ai-autonomy-from-legacy-mindsets-to-battlefield-dominance/](https://warontherocks.com/2025/12/chasing-true-ai-autonomy-from-legacy-mindsets-to-battlefield-dominance/)  
29. CyCon 2025 Series – Artificial Intelligence in Armed Conflict: The Current State of International Law \- Lieber Institute West Point, accessed on March 11, 2026, [https://lieber.westpoint.edu/artificial-intelligence-armed-conflict-current-state-international-law/](https://lieber.westpoint.edu/artificial-intelligence-armed-conflict-current-state-international-law/)  
30. Middle East Crisis Threatens Global AI Chip Supply \- Gotrade, accessed on March 11, 2026, [https://www.heygotrade.com/en/news/middle-east-crisis-threatens-global-ai-chip-supply](https://www.heygotrade.com/en/news/middle-east-crisis-threatens-global-ai-chip-supply)  
31. Stress Testing the Digital Economy: War in the Middle East and the Global IT Outlook \- IDC, accessed on March 11, 2026, [https://www.idc.com/resource-center/blog/stress-testing-the-digital-economy-war-in-the-middle-east-and-the-global-it-outlook/](https://www.idc.com/resource-center/blog/stress-testing-the-digital-economy-war-in-the-middle-east-and-the-global-it-outlook/)  
32. Semiconductors are a New Weapon of Geopolitics: The U.S.–China Rivalry, AI, and the Future of Global Security, accessed on March 11, 2026, [https://www.etd.ceu.edu/2025/maksakova\_anastasia.pdf](https://www.etd.ceu.edu/2025/maksakova_anastasia.pdf)  
33. Made in China 2025: Evaluating China's Performance, accessed on March 11, 2026, [https://www.uscc.gov/research/made-china-2025-evaluating-chinas-performance](https://www.uscc.gov/research/made-china-2025-evaluating-chinas-performance)  
34. AI safety and security can enable innovation in Global Majority countries | Brookings, accessed on March 11, 2026, [https://www.brookings.edu/articles/ai-safety-and-security-can-enable-innovation-in-global-majority-countries/](https://www.brookings.edu/articles/ai-safety-and-security-can-enable-innovation-in-global-majority-countries/)  
35. Verification for International AI Governance \- Oxford Martin AI ..., accessed on March 11, 2026, [https://aigi.ox.ac.uk/wp-content/uploads/2025/07/Verification\_for\_International\_AI\_Governance.pdf](https://aigi.ox.ac.uk/wp-content/uploads/2025/07/Verification_for_International_AI_Governance.pdf)  
36. Governing AI for Humanity: Final Report \- the United Nations, accessed on March 11, 2026, [https://www.un.org/sites/un2.un.org/files/governing\_ai\_for\_humanity\_final\_report\_en.pdf](https://www.un.org/sites/un2.un.org/files/governing_ai_for_humanity_final_report_en.pdf)  
37. Signatories: 86 countries adopt non-binding safety pledge for AI systems \- Actually Relevant, accessed on March 11, 2026, [https://actuallyrelevant.news/stories/86-countries-adopt-non-binding-safety-pledge-for-ai-systems](https://actuallyrelevant.news/stories/86-countries-adopt-non-binding-safety-pledge-for-ai-systems)  
38. Technology and Innovation Report 2025 \- Chapter V: Global collaboration for inclusive and equitable AI \- UNCTAD, accessed on March 11, 2026, [https://unctad.org/system/files/official-document/tir2025ch5\_en.pdf](https://unctad.org/system/files/official-document/tir2025ch5_en.pdf)  
39. Bridging Soft and Hard Law in AI Governance, accessed on March 11, 2026, [https://www.biicl.org/blog/121/bridging-soft-and-hard-law-in-ai-governance](https://www.biicl.org/blog/121/bridging-soft-and-hard-law-in-ai-governance)  
40. A Prisoner's Dilemma in the Race to Artificial General Intelligence | RAND, accessed on March 11, 2026, [https://www.rand.org/content/dam/rand/pubs/research\_reports/RRA4200/RRA4245-1/RAND\_RRA4245-1.pdf](https://www.rand.org/content/dam/rand/pubs/research_reports/RRA4200/RRA4245-1/RAND_RRA4245-1.pdf)