...
| :---- | :---- | :---- | :---- | :---- |
| **900 MHz** | Access Block 1 | 880.2 – 889.6 | 925.2 – 934.6 | Cell C |
| **900 MHz** | Access Block 2 | 904.2 – 905.4 | 949.2 – 950.4 | Cell C |
...
| :---- | :---- | :---- | :---- |
| **2017 Recapitalization** | Blue Label, Net1 UEPS, SPV1 (Cedar), SPV2 (Magnolia), SPV3 (Yellowwood) | Blue Label invested R5.5 billion for a 45% stake. Staff and BEE vehicles acquired minority positions. | 3C Telecommunications' stake in Cell C diluted to 35%. CellSAf diluted to single digits, launching high-court challenges. |
...
| :---- | :---- | :---- | :---- | :---- |
| **Total Carrying Assets** | 12,242,924 | 14,130,474 | 13,813,396 | 15,020,220 |
| **Total Accrued Liabilities** | 16,634,611 | 17,309,515 | 17,141,677 | 16,063,918 |
| **Net Total Equity (Solvency)** | (4,391,687) | (3,179,041) | (3,328,281) | (1,043,698) |

This operational turnaround paved the way for Blue Label to implement its ultimate restructuring goal: listing Cell C on the Main Board of the JSE. On November 27, 2025, Cell C officially listed on the JSE at an offer price of R26.50 per share, establishing a market capitalization of approximately R9 billion.

The IPO was highly complex and met with caution by some institutional investors who cited the ongoing legal disputes and historical technical insolvency. Ultimately, the IPO raised R2.7 billion—falling short of its original R7.7 billion goal—and was effectively anchored by Allan Gray, which acquired a 15.54% stake for R1.4 billion (representing half of the public float).

Despite the lower-than-expected capital raise, the listing successfully achieved several strategic imperatives:

> * It decoupled Cell C’s day-to-day operations from Blue Label, creating a clean, standalone corporate governance structure.
> * The proceeds were utilized to settle long-standing interest-bearing borrowing and historical lease provider claims, including a R750 million settlement funded via an airtime transfer conversion mechanism.
> * It simplified Blue Label's balance sheet, which had previously written down its multi-billion-rand investment in Cell C to zero in 2019\. Blue Label retained a controlling shareholding of 49.47% (accounting for it as an equity-accounted associate) while relinquishing day-to-day control.

The listing was further supported by broader regulatory reforms initiated by the JSE. In September 2024, the exchange repositioned its Main Board into Prime and General Segments to reduce the regulatory burden on smaller issuers. This was followed in January 2026 by the Financial Sector Conduct Authority’s (FSCA) approval of the JSE’s Simplification Project, which reduced the volume of listing requirements by more than half and lowered administrative barriers. These reforms provided Cell C with a more supportive environment as it transitioned to a public entity.
