...
- **Phase I: Stop Self-Destructive Behavior**: Focuses on eliminating fundamental dysfunctions that prevent clarity and alignment.

- **Phase II: Become More Context Aware**: Dedicated to building the structural and operational capabilities necessary for speed and localized decision-making.

- **Phase III: Better for Less**: Aims for economic excellence through optimization, ruthless flow management, and setting exceptional standards.
...
- **Communication**: Pertains to establishing clarity, shared language, and transparent information flow.

- **Development**: Concerns the creation, iteration, and appropriate methodologies for organizational components.

- **Operations**: Relates to the day-to-day management, flow optimization, and efficiency metrics.

- **Learning**: Defines the formal mechanisms and cultural disposition toward acquiring knowledge, using objective data, and testing hypotheses.

- **Leading**: Covers the strategic direction, the velocity of decision-making, and the required temperament of executive roles.
...
**Table 1: Wardley Doctrine – Index of 40 Universal Principles by Phase and Category**

| Phase of Implementation | Operational Category | Universal Principle | Description / Goal |
|------------------------|---------------------|--------------------|--------------------|
| I. Stop Self-Destructive Behavior | Communication | 1. Use a common language | Necessary for collaboration; reduces translation error and misalignment. |
| I. Stop Self-Destructive Behavior | Communication | 2. Challenge assumptions | Speak up and question accepted norms and existing practices. |
| I. Stop Self-Destructive Behavior | Communication | 3. Focus on high situational awareness | Understand what is being considered, often achieved through mapping. |
| I. Stop Self-Destructive Behavior | Development | 4. Know your users | Understand customers, shareholders, regulators, and staff. |
| I. Stop Self-Destructive Behavior | Development | 5. Focus on user needs | Prioritize outcomes that satisfy the user. |
| I. Stop Self-Destructive Behavior | Development | 6. Remove bias and duplication | Eliminate unwarranted replication, waste, and subjective judgment. |
| I. Stop Self-Destructive Behavior | Development | 7. Use appropriate methods | Select methodologies (e.g., Agile, Lean, Six Sigma) based on context. |
| I. Stop Self-Destructive Behavior | Learning | 8. Use a systematic mechanism of learning | Maintain a preference for objective data and measurable feedback. |
| I. Stop Self-Destructive Behavior | Operations | 9. Think small (as in know the details) | Maintain detailed, granular awareness of components and dependencies. |
| II. Becoming More Context Aware | Communication | 10. Be transparent (a bias towards open) | Ensure relevant information is shared openly across the organization. |
| II. Becoming More Context Aware | Development | 11. Focus on the outcome not a contract | Prioritize worth-based development over strict contractual adherence. |
| II. Becoming More Context Aware | Development | 12. Be pragmatic | Success is measured by results, not ideology. |
| II. Becoming More Context Aware | Development | 13. Use appropriate tools | Utilize situational analysis tools, such as mapping and financial models. |
| II. Becoming More Context Aware | Development | 14. Think FIRE | Fast, Inexpensive, Restrained, and Elegant (frugality and agility). |
| II. Becoming More Context Aware | Development | 15. Use standards where appropriate | Apply standardization judiciously based on component maturity. |
| II. Becoming More Context Aware | Leading | 16. Move fast | An imperfect, executed plan is superior to a perfect, delayed plan. |
| II. Becoming More Context Aware | Leading | 17. Strategy is iterative not linear | Employ fast, reactive cycles rather than rigid long-term plans. |
| II. Becoming More Context Aware | Leading | 18. Manage inertia | Actively counter existing practices, political capital, and previous investment. |
| II. Becoming More Context Aware | Learning | 19. A bias towards action | Learn by execution and gathering experiential data. |
| II. Becoming More Context Aware | Operations | 20. Manage failure | Design systems and processes that account for inevitable failures. |
| II. Becoming More Context Aware | Operations | 21. Effectiveness over efficiency | Focus on ensuring the right things are done before optimizing them. |
| II. Becoming More Context Aware | Structure | 22. Think aptitude and attitude | Prioritize capability and mindset in team formation. |
| II. Becoming More Context Aware | Structure | 23. Think small (teams) | Use small, manageable units, such as "two pizza" teams. |
| II. Becoming More Context Aware | Structure | 24. Distribute power and decision making | Empower smaller units and individuals to act autonomously. |
| III. Better for Less | Leading | 25. Be the owner | Take full personal responsibility for outcomes. |
| III. Better for Less | Leading | 26. Think big | Provide direction and inspire others with ambition. |
| III. Better for Less | Leading | 27. Strategy is complex | Acknowledge uncertainty and non-linearity. |
| III. Better for Less | Leading | 28. Commit to the direction, be adaptive along the path | Maintain strategic intent while adapting tactics locally ("crossing the river by feeling the stones"). |
| III. Better for Less | Leading | 29. Be humble | Listen, be selfless, and demonstrate fortitude. |
| III. Better for Less | Learning | 30. A bias towards the new | Be curious and take appropriate, calculated risks. |
| III. Better for Less | Operations | 31. Optimise flow | Ruthlessly remove bottlenecks impeding value delivery. |
| III. Better for Less | Operations | 32. Do better with less | Continual improvement in resource utilization. |
| III. Better for Less | Operations | 33. Set exceptional standards | Recognize that "great is just not good enough". |
| III. Better for Less | Structure | 34. Seek the best | Recruit and retain top-tier talent. |
| III. Better for Less | Structure | 35. Provide purpose, mastery, & autonomy | Implement intrinsic motivation drivers (PMA). |
| IV. Continuously Evolve | Leading | 36. Exploit the landscape | Actively use mapping insights for competitive advantage. |
| IV. Continuously Evolve | Leading | 37. There is no core | Recognize that all components are transient and evolving. |
| IV. Continuously Evolve | Learning | 38. Listen to your ecosystems | Use external interactions as future sensing engines. |
...
**Principle 1: Use a common language**. Strategic alignment is compromised when different organizational functions, such as IT and business process teams, use disparate diagrams or terminology to describe the same components or processes, leading to translation errors and misalignment. The doctrine mandates a single, shared descriptive method, with Wardley Maps often fulfilling this role, establishing that if the situation cannot be mapped or clearly articulated, action should be withheld until clarity is achieved.

**Principle 2: Challenge assumptions**. Organizational growth often relies on unspoken or historical beliefs that must be actively questioned to ensure decisions are grounded in current, objective reality.
...
**Principles 4 & 5: Know your users and Focus on user needs**. These foundational principles mandate a deep understanding of all stakeholders—customers, shareholders, staff, and regulators—to ensure development outcomes address genuine needs rather than internal political demands or pet projects.

**Principle 6: Remove bias and duplication**. Systematically eliminating redundant efforts (duplication) and subjective judgment (bias) is necessary to eliminate waste and unwarranted replication of components across the organization.
...
**Principle 8: Use a systematic mechanism of learning**. This requires establishing formalized feedback loops and maintaining a strong cultural preference for data-driven decision-making, ensuring a "bias towards data".
...
**Principle 16: Move fast**. This is the core behavioral mandate for velocity, asserting that the risk associated with pursuing a theoretically perfect, but delayed, plan outweighs the drawbacks of executing an imperfect plan immediately.   

**Principle 17: Strategy is iterative not linear**. Strategy must be practiced as a continuous cycle of observation and adaptation, formalizing fast, reactive cycles instead of inflexible, linear planning.   
...
**Principle 14: Think FIRE (Fast, Inexpensive, Restrained, and Elegant)**. This prescriptive design philosophy demands that solutions minimize complexity and resource commitment. This focus on frugality and agility reduces the cost of failure and increases the rate of iteration.   

**Principle 13: Use appropriate tools**. The doctrine mandates the deployment of tools that enhance situational awareness, such as mapping, and precise financial analysis to ground strategic and development decisions in objective analysis.   

**Principle 15: Use standards where appropriate**. Standardization is a lever for efficiency and cost reduction but must be applied judiciously, typically to highly evolved, commodity components. Applying rigid standards to novel or custom components impedes essential innovation.   
...
**Principle 21: Effectiveness over efficiency**. This is a critical directive requiring the organization to focus first on ensuring the activities being pursued are the right ones (effectiveness). Only after effectiveness is confirmed should resources be devoted to optimizing how those activities are performed. Making an ineffective activity more efficient only results in faster waste.   

**Principle 20: Manage failure**. Moving fast inevitably increases the frequency of localized failure. This principle mandates that systems must be designed to contain and mitigate inevitable breakdowns, treating failure as a mandatory learning mechanism, rather than a catastrophic event.   

**Principle 19: A bias towards action**. The learning mechanism favors empirical data gained through immediate execution ("learn by playing the game") over protracted theoretical analysis.   
...
**Principle 23: Think small (teams)**. Adopting small, high-agency teams, often referenced as "two pizza" teams, minimizes communication overhead and maximizes velocity.   

**Principle 24: Distribute power and decision making**. Strategic execution cannot be centralized if high velocity is the goal. Authority must be delegated to these small units, eliminating the central choke point of strategic approval and fostering local context-dependent decisions.   
...
**Principle 25: Be the owner**. This principle mandates full personal responsibility for outcomes across all organizational layers, countering cultures of deflection or blame.   

**Principle 26: Think big**. Leaders must articulate an ambitious, high-level direction that inspires and provides clear alignment for the now highly distributed organizational units.   

**Principle 28: Commit to the direction, be adaptive along the path**. This principle defines modern strategic flexibility: maintaining unwavering commitment to the strategic intent while allowing for tactical adjustments dictated by local context. This concept is often described by the analogy of "crossing the river by feeling the stones".   
...
**Principle 31: Optimise flow**. This is the operational mandate to systematically remove any impediment—structural, political, or technical—that slows down the delivery of value to the user. This requires ruthlessly examining the processes and structures established in Phase II.   

**Principle 32: Do better with less**. Following flow optimization, this principle guides continual improvement by seeking to increase output and quality while minimizing resource input and waste.   
...
**Principle 35: Provide purpose, mastery, & autonomy (PMA)**. This principle mandates that organizational structure must intentionally cultivate intrinsic motivation. Empowering employees with clarity of purpose, opportunities for skill development (mastery), and control over their work (autonomy) is essential for maximizing the output and retention within small, distributed teams.   

**Principle 34: Seek the best**. A commitment to continuous high-level talent acquisition and retention is necessary to sustain the exceptional standards mandated by the phase.   
...
**Principle 39: Design for constant evolution**. This highest structural principle mandates that organizational architecture, systems, and processes must inherently facilitate and support continuous change, rather than resisting it.   
...
**Principle 37: There is no core (Leading)**. This is a profound strategic acceptance that all components, even those currently considered proprietary or uniquely valuable, are transient and will inevitably be subject to evolutionary forces and commoditization. This perspective prevents strategic complacency and mandates continuous renewal.   

**Principle 36: Exploit the landscape (Leading)**. At this mature stage, the comprehensive situational awareness built through Phases I-III must be actively leveraged to execute sophisticated gameplays for competitive advantage.   
